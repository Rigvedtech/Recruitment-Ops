"""
Profile Model - Uses PostgreSQL ENUMs as the ONLY source of truth.
...
class Profile(db.Model):
    ...
    source = db.Column(db.String(50), nullable=True)  # Uses PostgreSQL enum values as strings
    ...
    status = db.Column(db.String(20), nullable=True)  # Uses PostgreSQL enum values as strings
