...
class Screening(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('requirement_id', 'profile_id', name='uq_screening_requirement_profile'),
    )
    
    screening_id = db.Column(GUID, primary_key=True, server_default=postgresql_uuid_default())
